            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-12 col-md-2 left_sec_col">
                        <div className="row"><div className="cl-12"> <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-chevron-compact-up" viewBox="0 0 16 16">
