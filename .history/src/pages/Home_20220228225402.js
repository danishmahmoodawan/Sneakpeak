...
function Home() {
 ...
 <section className="top_section">
            ...
            <div className="container">
                <div className="row d-flex align-items-center justify-content-center">
                    ...
                    <div className="col-12 col-md-2 left_sec_col text-center">
                        <div className="row"><div className="col-12 icon_size p-0"> <a href="#" target={{target:"_blank"}}> <svg xmlns="http://www.w3.org/2000/svg" width="50" height="40" fill="currentColor" className="bi bi-chevron-compact-up" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M7.776 5.553a.5.5 0 0 1 .448 0l6 3a.5.5 0 1 1-.448.894L8 6.56 2.224 9.447a.5.5 0 1 1-.448-.894l6-3z"/>
</svg></a></div>
 </div>
                        <div className="row"><div className="col-12 icon_size p-0"><span className="counts"> 5 </span></div> </div>
                        <div className="row"><div className="col-12 icon_size p-0"><a href="#" target={{target:"_blank"}}> <svg xmlns="http://www.w3.org/2000/svg" width="50" height="40" fill="currentColor" className="bi bi-chevron-compact-down" viewBox="0 0 16 16">
  ...
  <span className="position-absolute top-0 start-100 translate-middle badge rounded-pill set_ict">
  ...
  <p className="text-right">25%</p>
                 ...
                 <div className="col-sm-12 col-md-4">
                 <div className="btn map_bg map_one maptwo btn-primary position-relative">
             <p>    Lorem ipsum dolor sit amet consectetur adipiscing elit Aliquam ac dapibus orci sit amet laoreet odio Sed commodo nulla sit amet est posuere lobortis Maecenas ultrices justo non cursus finibus </p>
  <span className="position-absolute top-0 start-100 translate-middle badge rounded-pill set_ict">
  ...
  <p className="text-right">25%</p>
        ...
        <section className="forth_section faq_container">
            <div className="container">
            <div className="row">
            <div className="col-5 col-md-4 col_pading faq_col p-5">
            <img src="assets/images/faq.png" alt="PREVIEW_Artboard321293" className="desktop122_image" />
</div>
            <div className="col-7 col-md-8 anser p-5">
    ...
    <div className="tab-content pt-0">
      ...
      <div className="tab-pane fade" id="panel14" role="tabpanel">
        ...
        <section className="six_section">
            ...
            <div className="row">
            <div className="col-4">
            <img src="assets/images/char_img.png" alt="char_img" className="desktop122_image" />
            </div>
            <div className="col-4">
            <img src="assets/images/char_img.png" alt="char_img" className="desktop122_image" />
            </div>
        ...
        <div className="container">
        <div className="row">
            <div className="col-12 col-md-4 col_whites ">
            <img src="assets/images/project_name.png" alt="char_img" className="desktop122_image" />
            </div>
            </div>
            </div>
        </section>
