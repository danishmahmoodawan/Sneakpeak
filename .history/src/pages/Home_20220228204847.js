 ...
 <section className="top_section">
  ...
  <p className="text-right">25%</p>
        ...
        <section className="forth_section">
            ...
            <div className="col-4">
            <img src="assets/images/f.png" alt="PREVIEW_Artboard321293" className="desktop122_image" />
</div>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-12 col-12 forth_left_col">
                        

  <div className="container my-4">

<p className="font-weight-bold">An example of bootstrap tabs vertical . Easy to implement and customize. Examples of basic and advanced usage.</p>

<p>
  <strong>Detailed documentation and more examples you can find in our 
  <a href="https://mdbootstrap.com/docs/jquery/components/pills/" target="_blank">Docs</a>
  </strong> 
</p>
...
<div className="col-md-3 mb-4 ">
    ...
    <ul className="nav md-pills pills-secondary d-flex flex-column">
      <li className="nav-item">
        <a className="nav-link active" data-toggle="tab" href="#panel11" role="tab">Link 1</a>
      </li>
      <li className="nav-item">
        <a className="nav-link" data-toggle="tab" href="#panel12" role="tab">Link 2</a>
      </li>
      <li className="nav-item">
        <a className="nav-link" data-toggle="tab" href="#panel13" role="tab">Link 3</a>
      </li>
      <li className="nav-item">
        <a className="nav-link" data-toggle="tab" href="#panel14" role="tab">Link 4</a>
      </li>
    </ul>
