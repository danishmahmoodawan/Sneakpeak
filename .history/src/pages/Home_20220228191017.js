        ...
        <section className="second_section">
            <div className="container">
                <div className="row d-flex align-items-center justify-content-center">
                    <div className="col-12 col-md-4 left_sec_col img_col">
                        <div className="row">
                          <div className="col-12 right_inner_sec_col row_set_whi">
                                <div className="row">
                                    <div className="col- col_white">
                                        <p>PRICE</p>
                                    </div>
                    ...
                    <div className="col-12 col-md-2 left_sec_col text-center">
                        <div className="row"><div className="col-12 icon_size p-0"> <svg xmlns="http://www.w3.org/2000/svg" width="50" height="40" fill="currentColor" class="bi bi-chevron-compact-up" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M7.776 5.553a.5.5 0 0 1 .448 0l6 3a.5.5 0 1 1-.448.894L8 6.56 2.224 9.447a.5.5 0 1 1-.448-.894l6-3z"/>
</svg></div>
 </div>
                        <div className="row"><div className="col-12 icon_size p-0"><span class="counts"> 5 </span></div> </div>
                        <div className="row"><div className="col-12 icon_size p-0"> <svg xmlns="http://www.w3.org/2000/svg" width="50" height="40" fill="currentColor" class="bi bi-chevron-compact-down" viewBox="0 0 16 16">
