            ...
            <div className="container">
                <div className="row d-flex align-items-center justify-content-center">
                    ...
                    <div className="col-12 col-md-2 left_sec_col text-center">
                        <div className="row"><div className="col-12 icon_size p-0"> <a href="https://twitter.com/zerozeronft" target={{target:"_blank"}}> <svg xmlns="http://www.w3.org/2000/svg" width="50" height="40" fill="currentColor" class="bi bi-chevron-compact-up" viewBox="0 0 16 16">
